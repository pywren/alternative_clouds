...
def extract_storage_config(config):
    ...
    if storage_config['storage_backend'] == 's3':
        ...
        storage_config['storage_prefix'] = config['s3']['pywren_prefix']
    elif storage_config['storage_backend'] == 'google':
        ...
        storage_config['storage_prefix'] = config['google_storage']['pywren_prefix']
